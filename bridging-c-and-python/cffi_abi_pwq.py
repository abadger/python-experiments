...
# Load the binding Kinda a hack.  Setting this here makes the api match with how we use cffi's
# out-of-line api mode.  Maybe we should make both the api and abi mode's keep toplevel references
# to .lib and .ffi instead.
class CffiLibrary:
    def __init__(self, library_name):
        self.ffi = init_library('%s.h' % library_name)
        self.lib = self.ffi.dlopen(ctypes.util.find_library(library_name))


_LIBPWQ = CffiLibrary('pwquality')
